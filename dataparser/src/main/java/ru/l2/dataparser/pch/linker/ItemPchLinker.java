package ru.l2.dataparser.pch.linker;
...
public class ItemPchLinker {
    ...
    private static final ItemPchLinker ourInstance = new ItemPchLinker();
    ...
    public void load() {
        try {
            BufferedReader br = Files.newBufferedReader(Paths.get(ITEM_PCH_FILE_NAME), Charset.forName("UTF-16"));
            String line;
