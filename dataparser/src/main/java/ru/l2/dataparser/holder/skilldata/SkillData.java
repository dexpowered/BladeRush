package ru.l2.dataparser.holder.skilldata;

import ru.l2.dataparser.annotations.value.*;
import ru.l2.dataparser.holder.skilldata.abnormal.AbnormalType;
import ru.l2.dataparser.holder.skilldata.abnormal.AbnormalVisualEffect;
