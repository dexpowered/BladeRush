package ru.l2.dataparser.holder.npcdata;

import ru.l2.dataparser.annotations.array.DoubleArray;
...
import ru.l2.dataparser.holder.itemdata.ItemData;

import java.util.Map;

import static ru.l2.dataparser.holder.NpcDataHolder.NpcAIObjectFactory;
