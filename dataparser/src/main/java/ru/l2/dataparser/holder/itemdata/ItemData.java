package ru.l2.dataparser.holder.itemdata;
...
import ru.l2.dataparser.annotations.value.*;
import ru.l2.dataparser.holder.itemdata.item.ec_cond.DefaultEquipCond;
import ru.l2.dataparser.holder.itemdata.item.use_cond.DefaultUseCond;

import static ru.l2.dataparser.holder.ItemDataHolder.*;
