...
import ru.l2.dataparser.holder.cubicdata.Agathion;
import ru.l2.dataparser.holder.cubicdata.Cubic;
import ru.l2.dataparser.holder.cubicdata.DefaultCubicData;

import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import static ru.l2.dataparser.holder.cubicdata.Agathion.AgathionTimeSkill;
import static ru.l2.dataparser.holder.cubicdata.DefaultCubicData.*;
