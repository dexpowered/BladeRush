...
import ru.l2.gameserver.model.TeleportLocation;
...
import ru.l2.gameserver.templates.npc.AbsorbInfo.AbsorbType;
                ...
                if ("set".equalsIgnoreCase(firstElement.getName())) {
                    ...
                    for (final Element eElement3 : firstElement.getChildren()) {
                        if ("defence".equalsIgnoreCase(eElement3.getName())) {
                            final ru.l2.gameserver.model.base.Element element = ru.l2.gameserver.model.base.Element.getElementByName(eElement3.getAttributeValue("attribute"));
