...
import ru.l2.gameserver.data.xml.holder.FishDataHolder;
import ru.l2.gameserver.templates.item.support.FishGroup;
import ru.l2.gameserver.templates.item.support.FishTemplate;
import ru.l2.gameserver.templates.item.support.LureTemplate;
import ru.l2.gameserver.templates.item.support.LureType;
