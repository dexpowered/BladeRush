...
import ru.l2.gameserver.data.xml.holder.SuperPointHolder;
import ru.l2.gameserver.network.lineage2.components.ChatType;
import ru.l2.gameserver.templates.npc.superPoint.SuperPoinCoordinate;
import ru.l2.gameserver.templates.npc.superPoint.SuperPoint;
import ru.l2.gameserver.templates.npc.superPoint.SuperPointType;
