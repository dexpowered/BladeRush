...
import ru.l2.gameserver.templates.item.support.EnchantScroll;
import ru.l2.gameserver.templates.item.support.EnchantScrollOnFailAction;
import ru.l2.gameserver.templates.item.support.EnchantTargetType;
