package ru.l2.gameserver.handler.items;
...
import ru.l2.gameserver.templates.item.support.VariationChanceData;
import ru.l2.gameserver.templates.item.support.VariationGroupData;
