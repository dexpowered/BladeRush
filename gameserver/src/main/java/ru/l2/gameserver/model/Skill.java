...
import ru.l2.gameserver.model.entity.olympiad.OlympiadGameType;
...
import ru.l2.gameserver.network.lineage2.serverpackets.FlyToLocation.FlyType;
...
import ru.l2.gameserver.skills.skillclasses.*;
import ru.l2.gameserver.skills.skillclasses.DeathPenalty;
...
public abstract class Skill extends StatTemplate implements Cloneable {
    ...
    public enum SkillType {
        ...
        EFFECT(ru.l2.gameserver.skills.skillclasses.Effect.class),
        EFFECTS_FROM_SKILLS(EffectsFromSkills.class),
        ENCHANT_ARMOR,
        ENCHANT_WEAPON,
        FEED_PET,
        FISHING(FishingSkill.class),
        HARDCODED(ru.l2.gameserver.skills.skillclasses.Effect.class),
        ...
        SUMMON(ru.l2.gameserver.skills.skillclasses.Summon.class),
