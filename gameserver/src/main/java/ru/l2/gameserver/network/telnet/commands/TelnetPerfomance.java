...
import ru.l2.gameserver.taskmanager.EffectTaskManager;
...
public class TelnetPerfomance implements TelnetCommandHolder {
    ...
    public TelnetPerfomance() {
        ...
        _commands.add(new TelnetCommand("mem", "m") {
            ...
            @Override
            public String handle(final String[] args) {
                return String.valueOf(StatsUtils.getMemUsage());
            }
        });
        ...
        _commands.add(new TelnetCommand("gc") {
            ...
            @Override
            public String handle(final String[] args) {
                return String.valueOf(StatsUtils.getGCStats());
            }
        });
        _commands.add(new TelnetCommand("net", "ns") {
            ...
            @Override
            public String handle(final String[] args) {
                return String.valueOf(SelectorThread.getStats());
            }
        });
        _commands.add(new TelnetCommand("pathfind", "pfs") {
            ...
            @Override
            public String handle(final String[] args) {
                return String.valueOf(PathFindBuffers.getStats());
            }
        });
