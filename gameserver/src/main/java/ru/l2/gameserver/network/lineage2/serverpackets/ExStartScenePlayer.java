...
import ru.l2.gameserver.network.lineage2.components.SceneMovie;
...
public class ExStartScenePlayer extends L2GameServerPacket {
    ...
    public ExStartScenePlayer(final int sceneId) {
        _sceneId = sceneId;
    }

    public ExStartScenePlayer(final SceneMovie scene) {
