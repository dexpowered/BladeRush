...
public class InstantZone {
    ...
    public InstantZone(final int id, final String name, final SchedulingPattern resetReuse, final int sharedReuseGroup, final int timelimit, final boolean dispelBuffs, final int minLevel, final int maxLevel, final int minParty, final int maxParty, final int timer, final boolean onPartyDismiss, final List<Location> tele, final Location ret, final int mapx, final int mapy, final Map<Integer, DoorInfo> doors, final Map<String, ZoneInfo> zones, final Map<String, SpawnInfo2> spawns, final List<SpawnInfo> spawnsInfo, final int collapseIfEmpty, final int maxChannels, final int removedItemId, final int removedItemCount, final boolean removedItemNecessity, final int giveItemId, final int givedItemCount, final int requiredQuestId, final boolean setReuseUponEntry, final StatsSet params) {
        _id = id;
        _name = name;
