...
public class DoorTemplate extends CharTemplate {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DoorTemplate.class);
    ...
    public CharacterAI getNewAI(final DoorInstance door) {
        try {
            ...
            LOGGER.error("Unable to create ai of doorId " + _id, e);
