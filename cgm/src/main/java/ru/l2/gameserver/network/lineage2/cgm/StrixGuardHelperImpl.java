package ru.l2.gameserver.network.lineage2.cgm;


import ru.l2.gameserver.network.lineage2.CGMHelper;
import ru.l2.gameserver.network.lineage2.GameClient;
import ru.l2.gameserver.network.lineage2.GameCrypt;
import ru.l2.gameserver.network.lineage2.cgm.sxg.ISXGWrapper;
...
public class StrixGuardHelperImpl extends CGMHelper
{
    ...
    private static ISXGWrapper getWrapper() {
        ...
        try {
            inst = (ISXGWrapper) Class.forName("ru.l2.gameserver.network.lineage2.cgm.sxg.SXGWrapper").newInstance();
